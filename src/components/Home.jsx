    ...
    <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-7 md:flex-row">
      <div className="flex flex-col justify-center h-full">
        ...
        <p className="text-gray-500 py-6 px-7 max-w-md">
          A frontend developer with 1 year of experience designing and building responsive web design and 
          mobile apps for diverse organisations and individuals. Proficient with HTML, CSS, JavaScript libraries
          and frameworks, with extensive knowledge of user psychology.
        </p>
